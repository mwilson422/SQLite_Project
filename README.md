...
- To check that the tables are loaded corecctly use the sqlite command `.tables`. You should see the three tables created by running the CreateTables.sql and a bunch of other tables that hold the spatial information from SpatiaLite.
