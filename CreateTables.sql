...
/*
I would like to play around with some spatial queries on a database 
I'm creating in SQLite with SpatialLite. I want to create the tables and 
then insert data into the tables. Can you give me some generated sample 
data of 5 -20 points, 5-20 linestrings, 5 - 20 polygons with at least 3-4 
columns of string and numerical values as well as the geometry value 
(using BLOB method)
*/
...
-- Create table to hold line data
